...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('jquery-confirm-v3.3.4/dist/jquery-confirm.min.css') }}">
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="{{ asset('jquery-confirm-v3.3.4/dist/jquery-confirm.min.js') }}"></script>
