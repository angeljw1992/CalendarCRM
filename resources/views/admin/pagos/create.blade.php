    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pagos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('concepto') ? 'is-invalid' : '' }}" name="concepto" id="concepto" required>
                    ...
                    @foreach(App\Models\Pago::CONCEPTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('concepto', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('metodo') ? 'is-invalid' : '' }}" name="metodo" id="metodo" required>
                    ...
                    @foreach(App\Models\Pago::METODO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('metodo', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_asignada_de_pago') ? 'is-invalid' : '' }}" type="text" name="fecha_asignada_de_pago" id="fecha_asignada_de_pago" value="{{ old('fecha_asignada_de_pago') }}" required>
